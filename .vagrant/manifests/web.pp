...
exec { "create-musicjungle-user":
    unless => "/usr/bin/mysql -umusicjungle -pminha-senha musicjungle",
    command => "/usr/bin/mysql -uroot -e \"GRANT ALL PRIVILEGES ON * TO musicjungle@localhost IDENTIFIED BY 'minha-senha';\" musicjungle",
